...
import { ArrowRight, Code, Check, Zap } from "lucide-react";
    ...
    <>
      ...
      <BlogArticleShell
        ...
        title={
          <>
            Warum ich für KMU{" "}
            <em className="mh-italic-accent">kein WordPress mehr baue</em>.
          </>
        }
        lead={
          <>
        ...
        ctaTitle={
          <>
            Ihre Website{" "}
            <em className="mh-italic-accent text-mh-glow">zu langsam</em>?
          </>
        }
        ctaLead="Ich schaue mir im Erstgespräch Ihre Core Web Vitals an und sage Ihnen ehrlich, ob sich ein Umbau auf Next.js rechnet — oder ob ein Performance-Fix am bestehenden Stack reicht."
      >
        <SectionReveal>
