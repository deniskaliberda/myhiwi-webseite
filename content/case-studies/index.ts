...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    title: "Leistungen klar zeigen und den Weg zur Energieberatung öffnen",
    summary:
      "Ein neuer Webauftritt für das Architektur- und Ingenieurbüro: mit echten Projektfotos, überarbeiteten Leistungsseiten und einer kompakten Energieübersicht für private und größere Vorhaben.",
    standfirst:
      "Für Dr.-Ing. Formazin & Partner entstand ein neuer Webauftritt. Im September 2026 haben wir die Leistungsdarstellung und die Energieberatung weiter überarbeitet. Die aktuelle Website verbindet echte Projekte mit verständlichen Erklärgrafiken und direkten Wegen zur passenden Anfrage.",
    website: "https://www.formazin-partner.de",
    updated: "2026-09-07",
    cover: {
      src: asset("formazin", "2026-09-07/cover.webp"),
      alt: "Aktuelle Formazin-Energieübersicht mit zwei Anfrage-Einstiegen und verlinkter Infografik zur Sanierung",
      caption:
        "Öffentliche Energieübersicht mit verlinkter Infografik. Desktop-Aufnahme vom 7. September 2026.",
    },
    services: [
      { label: "Webseiten", href: "/leistungen/webseiten" },
      { label: "Google-Sichtbarkeit", href: "/leistungen/google-sichtbarkeit" },
    ...
    metrics: [
      {
        value: "5",
        label: "Energie-Leistungen im Überblick",
        period: "Öffentlicher Stand · 07.09.2026",
        source: "formazin-partner.de/leistungen/energieberatung",
        note: "iSFP, KfW-Baubegleitung, Energieausweis, GEG-Nachweis und Förderberatung sind jeweils verlinkt.",
      },
      {
        value: "2",
        label: "direkte Einstiege in die Energieberatung",
        period: "Öffentlicher Stand · 07.09.2026",
        source: "Einstieg der öffentlichen Energieübersicht",
        note: "Privates Wohnhaus sowie Unternehmen & größere Projekte. Zusätzlich gibt es eine allgemeine Anfrage.",
      },
      {
        value: "Live",
        label: "überarbeitete Leistungen und Bilder",
        period: "Veröffentlicht · 06.09.2026",
        source: "Öffentliche Leistungsseiten, geprüft am 07.09.2026",
        note: "Aktuelle Website-Aufnahmen zeigen den veröffentlichten Stand.",
      },
      {
        value: "Offen",
        label: "Wirkung auf Anfragen und Sichtbarkeit",
        period: "Einordnung · 07.09.2026",
        source: "Für diesen Stand kein belastbarer Wirkungsnachweis",
        note: "Keine Aussage über die Zahl der Anfragen, Abschlüsse oder eine Steigerung durch die Überarbeitung.",
      },
    ],
    challenge: {
      title: "Das Angebot eines Architektur- und Ingenieurbüros verständlich erschließen",
      body: "Architektur, Brandschutz, Tragwerksplanung, Generalplanung und Energieberatung gehören zusammen. Besucher brauchen trotzdem einen klaren Einstieg für ihr konkretes Vorhaben. Die Website sollte Leistungen erklären, echte Referenzen zeigen und den Kontakt zum Büro einfach erreichbar machen.",
    },
    improvements: [
      {
        title: "Leistungen mit echten Projektbeispielen",
        body: "Die überarbeiteten Leistungsseiten verbinden die Aufgaben des Büros mit Abläufen und verlinkten Referenzen. Auf der Architekturseite ist beispielsweise die Grundschule Lindenberg zu sehen. Kontaktlinks führen zum Kontaktbereich der Startseite.",
      },
      {
        title: "Kompakte Energieübersicht",
        body: "Eine verlinkte Infografik erklärt die Schritte von der Planung über die Förderung bis zur Begleitung der Umsetzung. Fünf Leistungskarten führen zu den Details. Ausführliche Angaben zu Kosten, Förderung und Nachweisen stehen auf den jeweiligen Unterseiten.",
      },
      {
        title: "Passende Einstiege und aktuelle Bilder",
        body: "Private Wohnhäuser und größere Vorhaben erhalten eigene Einstiege. Die Energieübersicht zeigt sachliche Leistungsgrafiken, echte Ansprechpartner und ein verlinktes Foto aus dem Projektportfolio. Die frühere KI-Fotobildwelt wurde dort ersetzt.",
      },
    ],
    gallery: [
      {
        src: asset("formazin", "2026-09-07/mobile.webp"),
        alt: "Mobiler Einstieg in die Energieberatung mit den Buttons Privates Wohnhaus und Unternehmen & größere Projekte",
        caption:
          "Energieberatung auf dem Smartphone. Sichtbarer Einstieg, aufgenommen am 7. September 2026.",
      },
      {
        src: asset("formazin", "2026-09-07/detail.webp"),
        alt: "Aktuelle Leistungsübersicht mit Architekturtext und echtem Projektfoto der Grundschule Lindenberg",
        caption:
          "Leistungsübersicht mit Architektur und Grundschule Lindenberg. Desktop-Aufnahme vom 7. September 2026.",
      },
    ],
    timeline: [
      {
        ...
        body: "Für das Büro entsteht ein neu aufgebauter Webauftritt.",
      },
      {
        date: "September 2026",
        title: "Energieberatung als eigener Themenbereich",
        body: "Leistungs- und Ortsseiten sowie passende Anfragewege erschließen das Energieangebot des Büros.",
      },
      {
        date: "06.09.2026",
        title: "Leistungen und Energieübersicht überarbeitet",
        body: "Überarbeitete Leistungsinhalte, die kompakte Energieübersicht mit Infografik und die aktuelle Bildauswahl sind veröffentlicht. Auf Über uns ergänzen verlinkte Original-Logos die Darstellung des Büros.",
      },
      {
        date: "07.09.2026",
        title: "Aktuellen öffentlichen Stand dokumentiert",
        body: "Die Aufnahmen dieser Fallstudie zeigen die öffentlich erreichbare Website auf Desktop und Smartphone.",
      },
    ],
    methodology: [
      "Grundlage sind die öffentlich erreichbaren Seiten auf www.formazin-partner.de, geprüft am 7. September 2026: Leistungsübersicht, Energieberatung, verlinkte Angebote und Über uns.",
      "Die fünf Energie-Leistungen und zwei hervorgehobenen Einstiege beschreiben die sichtbare Website-Struktur. Die allgemeine Anfrage ist zusätzlich erreichbar. Diese Angaben sind keine Erfolgskennzahlen.",
      "Alle gezeigten Website-Aufnahmen stammen vom 7. September 2026. Sie dokumentieren den veröffentlichten Stand, keine Entwürfe und keine Energieeinsparungen an Gebäuden.",
      "Für die aktuelle Überarbeitung liegt hier kein belastbarer Nachweis zu Suchwirkung, qualifizierten Anfragen oder Abschlüssen vor. Diese Ergebnisse bleiben offen. Frühere Suchwerte werden nicht als aktuelle Wirkung dargestellt.",
    ],
    outlook:
      "Ob die überarbeiteten Inhalte besser gefunden werden und zu passenden Anfragen führen, muss über einen geeigneten Beobachtungszeitraum geprüft werden. Weitere Inhalte werden erst nach ihrer Veröffentlichung Teil dieser Fallstudie.",
  },
  {
    slug: "mr-sherman",
